...
public class Paytmtest extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paytmtest);
